...
"-------------------------------------------------------------------------------
" Customize:
"  g:backup_directory   name of backup directory central to edited file
...
function s:Set_Backup (Doc_Path, Doc_Name)
   let l:Backup_Path = expand(g:backup_directory) . '/' . substitute( a:Doc_Path, '\(:\\\|\\\)', '/', 'g')
